using fashionDesignAPI.Database;
using fashionDesignAPI.Database.Repositories;
using fashionDesignAPI.Interfaces.Repositories;
using fashionDesignAPI.Interfaces.Services;
using fashionDesignAPI.Mapper;
using fashionDesignAPI.Middlewares;
using fashionDesignAPI.Services;
...
builder.Services.AddDbContext<FashionDesignDbContext>();
